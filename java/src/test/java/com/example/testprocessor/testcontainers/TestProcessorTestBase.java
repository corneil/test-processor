...
@SpringBootTest(classes = {TestListenerConfiguration.class, TestprocessorApplication.class},
...
public abstract class TestProcessorTestBase {
    protected static final Logger logger = LoggerFactory.getLogger(TestProcessorTestBase.class);
